...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Collaborator_Microservice",
        Version = "v1"
    });
...
builder.Services.AddDbContext<CollaboratorContext>(option => option.UseSqlServer(builder.Configuration.GetConnectionString("SqlConnection")));
